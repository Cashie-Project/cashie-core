        ...
        {isShowDropdown && (
          <div className="w-auto h-auto absolute top-[45px] right-[0px] bg-[#FFFFFF] rounded-[12px] shadow-md border-[1px] border-[#D9D9D9] flex flex-col items-start justify-start overflow-hidden">
            {languageList.map((languageItem: LanguageDataItem) => (
              <button
                type="button"
                className={`w-full h-auto px-[20px] py-[10px] text-left text-[16px] leading-[24px] text-[#000000] font-[700] cursor-pointer border-b-[1px] border-[#D9D9D9] ${languageItem.value == selectedLanguage.value ? 'bg-[#EEEEEE]' : 'bg-[#FFFFFF]'}`}
