...
const BusinessSolutionDropdown = (props: BusinessSolutionDropdownInterface) => {
  return (
    <>
      <div className="w-auto h-auto absolute top-[45px] left-[20px] bg-[#FFFFFF] rounded-[12px] shadow-md flex flex-col flex-nowrap items-start justify-start p-[25px] border-[1px] border-[#D9D9D9] overflow-hidden">
